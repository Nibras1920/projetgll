...
<!--header -->
			<header>
                ...
                <nav>
					...
					<li><a href="../js/AccueilManager.html"><span>Accueil</span></a></li>
...
<tr align="center" valign="middle">	
    ...
    <td align="center" valign="middle"><input type="radio" name="b" id="b" style="position:relative;" value="<?php echo $ligne['Service'];?>" /></td>	
    <?php }?>
</tr>

</table>
<input type="submit" class="button1" value="Rechercher" onclick="SubmitForm()"/>
</form>>
  </p>

...
<!--header -->
			<header>
				<div class="wrapper">
					 <h2><span class="color1"></span><span></span></h2>	
...
?>
					...
					<form id="ContactForm" method="post" action="ModifierAdministrateur.php">
						...
						<div  class="wrapper">
								...
								<div class="bg"><input type="text" class="input" name="id_administrateur" style="display:none"></div>
							</div>
							...
							<a href="GestionManagers.html"class="button1" onClick="document.getElementById('ContactForm').submit()">Annuler</a>
							<a href="AccueilAdmin.html" class="button1" onClick="document.getElementById('ContactForm').submit()">Modifier</a>

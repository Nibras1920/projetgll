...
<!--header -->
			<header>
                ...
                <nav>
					...
					<li><a href="AccueilAdmin.html"><span>Accueil</span></a></li>
...
?>
<h3>Modifier Manager</h3>
<form action="ModifierMan.php" method="post">
...
<tr align="center" valign="top" bgcolor="#009933" class="color1">
	...
	<td>   <p>&nbsp;</p></td>
    <th width="69" nowrap="nowrap"><p><strong>Modifier</strong></p></th>
...
<tr align="center" valign="middle">
    ...
    <td><input type="radio" name="b" value="<?php echo $ligne['IdManager'];?>" /></td>	
</tr>
<?php
}
?>
